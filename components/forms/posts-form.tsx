...
export const PostsForm: React.FC<PostFormProps<unknown>> = ({
  initialData,
  companyId,
}) => {
  ...
  const template = initialData ? "Template Oluşturuldu" : "Bir template seç";
      ...
      <div className="grid grid-cols-3 gap-20 mt-5">
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline">Tekli Gönderim</Button>
          </DialogTrigger>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline">Toplu Gönderim</Button>
          </DialogTrigger>
          <DialogContent className="">
            <DialogHeader></DialogHeader>
        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button variant="outline">Taahhütlü Gönderim</Button>
          </DialogTrigger>
          <DialogContent className="">
            <DialogHeader></DialogHeader>
